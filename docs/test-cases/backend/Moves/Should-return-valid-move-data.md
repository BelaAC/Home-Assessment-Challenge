...
4. Validate nested properties
   ...
   1. Each nested object exists
   2. Each nested object has required properties
   3. Property types match expected structure

5. Validate optional properties

   1. Optional properties can be present or null
   2. If present, validate their structure
   3. If null, ensure it's handled correctly
