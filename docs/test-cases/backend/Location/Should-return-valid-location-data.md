...
4. Validate region object
   ...
   1. Region object has required properties
   2. Name property is of correct type
   3. URL property is of correct type

5. Validate game indices array

   1. Game indices array exists
   2. Array is of correct type
   3. Array can be empty (valid case)

6. Validate areas array

   1. Areas array exists
   2. Array is of correct type
